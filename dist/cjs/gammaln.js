...
function gammaln(x) {
    ...
    if (x < 2.0) {
        ...
        switch (flg) { // eslint-disable-line default-case
            case 0:
                z = y * y;
                p1 = (0, helper_functions_1.polyval)(z, [
                ...
                p2 = z * (0, helper_functions_1.polyval)(z, [
            ...
            case 1:
                z = y * y;
                w = z * y;
                p1 = (0, helper_functions_1.polyval)(w, [
                ...
                p2 = (0, helper_functions_1.polyval)(w, [
                ...
                p3 = (0, helper_functions_1.polyval)(w, [
                ...
                break;
            case 2:
                p1 = y * (0, helper_functions_1.polyval)(y, [
                    -7.72156649015328655494e-02,
                ...
                p2 = (0, helper_functions_1.polyval)(y, [
                    1.0,
    ...
    // 2 <= x < 8
        ...
        flg = Math.trunc(x);
        y = x - flg;
        p = y * (0, helper_functions_1.polyval)(y, [
        ...
        q = (0, helper_functions_1.polyval)(y, [
            1.0,
    ...
    // 8 <= x < 2**58
        ...
        y = z * z;
        // w = WC + (z * polyvalW(y));
        w = WC + (z * (0, helper_functions_1.polyval)(y, [
